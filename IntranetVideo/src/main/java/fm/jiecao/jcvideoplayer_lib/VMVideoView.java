...
public class VMVideoView extends JCVideoPlayer {
    ...
    public VMVideoView(Context context) {
        super(context);
    }

    public VMVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setUp(Activity activity, String url, int screen, Object... objects) {
        super.setUp(activity, url, screen, objects);
