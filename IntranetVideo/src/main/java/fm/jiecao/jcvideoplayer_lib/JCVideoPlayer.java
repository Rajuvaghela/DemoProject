...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public void setUp(Activity activity,String url, int screen, Object... objects) {
...
//            int duration = getDuration();
        ...
        activity.setRequestedOrientation(NORMAL_ORIENTATION);
    ...
    public static boolean backPress() {
        ...
        if (JCVideoPlayerManager.getSecondFloor() != null) {
            ...
            jcVideoPlayer.onEvent(jcVideoPlayer.currentScreen == VMVideoView.SCREEN_WINDOW_FULLSCREEN ?
    ...
    public void startWindowFullscreen() {
        ...
        activity.setRequestedOrientation(FULLSCREEN_ORIENTATION);
...
//        ((ViewGroup)JCMediaManager.textureView.getParent()).removeView(JCMediaManager.textureView);
        ...
        try {
            ...
            jcVideoPlayer.setUp(activity,url, VMVideoView.SCREEN_WINDOW_FULLSCREEN, objects);
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public void startWindowTiny() {
        ...
        try {
            ...
            vp.addView(jcVideoPlayer, lp);
            jcVideoPlayer.setUp(activity,url, VMVideoView.SCREEN_WINDOW_TINY, objects);
            jcVideoPlayer.setUiWitStateAndScreen(currentState);
            jcVideoPlayer.addTextureView();
            JCVideoPlayerManager.setSecondFloor(jcVideoPlayer);
