...
public class ColorDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleTv.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"Montserrat-Regular.otf"));
        mContentTv.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"Montserrat-Regular.otf"));
