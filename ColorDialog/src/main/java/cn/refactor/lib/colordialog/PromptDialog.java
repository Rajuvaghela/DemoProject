...
public class PromptDialog extends Dialog {
    ...
    TextView mPositiveBtn,mNegativeBtn;
    ...
    private void initView() {
        ...
        mContentTv.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"Roboto-Regular.ttf"));
        mTitleTv.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"Roboto-Bold.ttf"));
      ...
      //  setBtnBackground(mNegativeBtn);
        ...
        mContentTv.setTextColor(Color.parseColor("#000000"));
    ...
    private void setBtnBackground(final ImageButton btnOk) {
       // btnOk.setTextColor(createColorStateList(getContext().getResources().getColor(getColorResId(mDialogType)),getContext().getResources().getColor(R.color.color_dialog_gray)));
