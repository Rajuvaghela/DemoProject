...
//            strHeaderTextColor = a.getString(R.styleable.MyCalendar_headerTextColor);
        ...
        Typeface tf2 = Typeface.createFromAsset(context.getAssets(), "Roboto-Bold.ttf");
        Typeface tf = Typeface.createFromAsset(context.getAssets(), "Roboto-Regular.ttf");


        tv_month_year.setTypeface(tf);

        tv_mon.setTypeface(tf);
        tv_tue.setTypeface(tf);
        tv_wed.setTypeface(tf);
        tv_thu.setTypeface(tf);
        tv_fri.setTypeface(tf);
        tv_sat.setTypeface(tf);
        tv_sun.setTypeface(tf);
...
//            }
    ...
    public void addEvent(String date, String startTime, String endTime, String nameOfToDo, int image,int image1,String personId,String peopleId,String id,String eventType,String fontcolor,String bgcolor) {
        if (!TextUtils.isEmpty(date) && !TextUtils.isEmpty(startTime) && !TextUtils.isEmpty(endTime) && !TextUtils.isEmpty(nameOfToDo)) {
            String tmpDate = GlobalMethods.convertDate(date, AppConstants.sdfDate, AppConstants.sdfDate);
            String tmpStartTime = GlobalMethods.convertDate(startTime, AppConstants.sdfHourMinute, AppConstants.sdfHourMinute);
            String tmpEndTime = GlobalMethods.convertDate(endTime, AppConstants.sdfHourMinute, AppConstants.sdfHourMinute);
            AppConstants.eventList.add(new EventModel(tmpDate, tmpStartTime, tmpEndTime, nameOfToDo, image,image1,personId,peopleId,id,eventType,fontcolor,bgcolor));
        }
    }
        ...
        dateListAdapter.setOnDateClickListener(new OnDateClickListener() {
            ...
            public void onClick(Date date,int position) {
                if (onDateClickListener != null) {
                    onDateClickListener.onClick(date,position);
                }
            }
