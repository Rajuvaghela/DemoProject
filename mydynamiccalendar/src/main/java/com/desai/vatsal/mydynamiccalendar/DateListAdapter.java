...
public class DateListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class DateViewHolder extends RecyclerView.ViewHolder {
        ...
        public DateViewHolder(View itemView) {
            ...
            tv_month_date.setTypeface(tf);
            tv_week_date.setTypeface(tf);
            tv_event_simbol.setTypeface(tf);
        ...
        public void setDates(final DateModel model) {
                ...
                for (int i = 0; i < AppConstants.eventList.size(); i++) {
                    if (AppConstants.eventList.get(i).getStrDate().equals(AppConstants.sdfDate.format(model.getDates()))) {
                       ...
                       /* if (AppConstants.eventList.get(i).getImage() != -1) {
                        ...
                        if(AppConstants.eventList.get(i).getImage() == 1){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view1);
                        }else if(AppConstants.eventList.get(i).getImage() == 2){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view2);
                        }else if(AppConstants.eventList.get(i).getImage() == 3){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view3);
                        }else if(AppConstants.eventList.get(i).getImage() == 4){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view4);
                        }else if(AppConstants.eventList.get(i).getImage() == 5){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view5);
                        }else if(AppConstants.eventList.get(i).getImage() == 6){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view6);
                        }else if(AppConstants.eventList.get(i).getImage() == 7){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view7);
                        }else if(AppConstants.eventList.get(i).getImage() == 8){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view8);
                        }else if(AppConstants.eventList.get(i).getImage() == 9){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view9);
                        }else if(AppConstants.eventList.get(i).getImage() == 10){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view10);
                        }else if(AppConstants.eventList.get(i).getImage() == 11){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view11);
                        }else if(AppConstants.eventList.get(i).getImage() == 12){
                            tv_event_simbol.setBackgroundResource(R.drawable.event_view12);
                        }
            ...
            ll_sub_parrent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onDateClickListener.onClick(model.getDates(),getLayoutPosition());
