...
public class Adapter2MessagesPeople3 extends RecyclerView.Adapter<Adapter2MessagesPeople3.ViewHolder> {


    Context context;
    static List<ModelClass3> list = new ArrayList<>();

    public Adapter2MessagesPeople3(Context context, List<ModelClass3> list) {
        super();
