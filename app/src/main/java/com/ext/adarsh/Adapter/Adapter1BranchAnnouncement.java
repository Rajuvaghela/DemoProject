...
public class Adapter1BranchAnnouncement extends RecyclerView.Adapter<Adapter1BranchAnnouncement.ViewHolder> implements Filterable {
    ...
    TextView textView;
    public Adapter1BranchAnnouncement(Context context1, List<BeanBranchList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Myannouncement.recyclerview_adapter2 = new Adapter2BranchAnnouncement(context, Myannouncement.item_list2);
        Myannouncement.rv_onchangelistner2();
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (list.get(position).isSelected() == false) {
                    ...
                    Myannouncement.item_list2.add(temp);
                    Myannouncement.recyclerview_adapter2 = new Adapter2BranchAnnouncement(context, Myannouncement.item_list2);
                    Myannouncement.rv_onchangelistner2();
                    ...
                    for (int j = 0; j < Myannouncement.item_list2.size(); j++) {
                        if (itemlist.branchId.equalsIgnoreCase(Adapter2BranchAnnouncement.list.get(j).getId())) {
                            Adapter2BranchAnnouncement.list.remove(j);
                        }
                    }
                    Myannouncement.rv_onchangelistner2();
