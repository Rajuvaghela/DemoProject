...
public class Adapter1BranchSharePost extends RecyclerView.Adapter<Adapter1BranchSharePost.ViewHolder> implements Filterable {
    ...
    public Adapter1BranchSharePost(Context context1, List<BeanBranchList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        AdapterFeedNews.recyclerview_adapter2 = new Adapter2Branch(context, AdapterFeedNews.item_list2);
        AdapterFeedNews.rv_onchangelistner2();
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    AdapterFeedNews.item_list2.add(temp);
                    AdapterFeedNews.recyclerview_adapter2 = new Adapter2BranchMyPolls(context, AdapterFeedNews.item_list2);
                    AdapterFeedNews.rv_onchangelistner2();
                    ...
                    for (int j = 0; j < AdapterFeedNews.item_list2.size(); j++) {
