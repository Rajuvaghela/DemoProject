...
public class Adapter2MessagesPeople2 extends RecyclerView.Adapter<Adapter2MessagesPeople2.ViewHolder> {


    Context context;
    static List<ModelClass2> list = new ArrayList<>();

    public Adapter2MessagesPeople2(Context context, List<ModelClass2> list) {
        super();
