...
public class Adapter2FileShare extends RecyclerView.Adapter<Adapter2FileShare.ViewHolder> {
    Context context;
    static List<ModelClass3> list = new ArrayList<>();
    public Adapter2FileShare(Context context, List<ModelClass3> list) {
        super();
