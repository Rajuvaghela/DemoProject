...
public class AdapterAnnouncementAttachment extends RecyclerView.Adapter<AdapterAnnouncementAttachment.ViewHolder> {
    Activity activity;
    Dialog openImage;
    List<BeanAnnoucementAttchment> list = new ArrayList<>();

    public AdapterAnnouncementAttachment(Activity activity, List<BeanAnnoucementAttchment> list) {
        super();
        ...
        holder.ll_approvals_attachment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (file_extension.equalsIgnoreCase(".jpg")) {
                    ...
                    intent.putExtra("pdf", list.get(position).filePath);
