...
public class Adapter1FileShare2 extends RecyclerView.Adapter<Adapter1FileShare2.ViewHolder> implements Filterable {
    ...
    public Adapter1FileShare2(Context context1, List<BeanPeopleFileShare> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        AdapterSubFile.recyclerview_adapter3 = new Adapter2FileShare(context, AdapterSubFile.item_list3);
        AdapterSubFile.rv_onchangelistner3();
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    AdapterSubFile.item_list3.add(temp);
                    AdapterSubFile.recyclerview_adapter3 = new Adapter2FileShare(context, AdapterSubFile.item_list3);
                    AdapterSubFile.rv_onchangelistner3();
                    ...
                    for (int j = 0; j < AdapterSubFile.item_list3.size(); j++) {
