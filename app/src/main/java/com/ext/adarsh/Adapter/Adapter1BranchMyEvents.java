...
public class Adapter1BranchMyEvents extends RecyclerView.Adapter<Adapter1BranchMyEvents.ViewHolder> implements Filterable {
    ...
    public Adapter1BranchMyEvents(Context context1, List<BeanBranchList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        EventAddActivity.recyclerview_adapter2 = new Adapter2BranchMyEvents(context, EventAddActivity.item_list2);
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    EventAddActivity.item_list2.add(temp);
                    EventAddActivity.recyclerview_adapter2 = new Adapter2BranchMyEvents(context, EventAddActivity.item_list2);
                    EventAddActivity.rv_onchangelistner2();
                    ...
                    for (int j = 0; j < polls.item_list2.size(); j++) {
                        if (itemlist.branchId.equalsIgnoreCase(Adapter2BranchMyEvents.list.get(j).getId())) {
                            Adapter2BranchMyEvents.list.remove(j);
                        }
                    }
