...
public class Adapter2BranchAnnouncement extends RecyclerView.Adapter<Adapter2BranchAnnouncement.ViewHolder> {


    Context context;
    static List<ModelClass2> list = new ArrayList<>();

    public Adapter2BranchAnnouncement(Context context, List<ModelClass2> list) {
        super();
