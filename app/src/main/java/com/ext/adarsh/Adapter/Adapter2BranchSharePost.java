...
public class Adapter2BranchSharePost extends RecyclerView.Adapter<Adapter2BranchSharePost.ViewHolder> {

    Context context;
    static List<ModelClass2> list = new ArrayList<>();

    public Adapter2BranchSharePost(Context context, List<ModelClass2> list) {
        super();
