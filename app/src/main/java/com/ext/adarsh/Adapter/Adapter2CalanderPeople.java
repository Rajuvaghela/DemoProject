...
public class Adapter2CalanderPeople extends RecyclerView.Adapter<Adapter2CalanderPeople.ViewHolder> {


    Context context;
    static List<ModelClass3> list = new ArrayList<>();

    public Adapter2CalanderPeople(Context context, List<ModelClass3> list) {
        super();
