...
public class AdapterSentMessage extends RecyclerView.Adapter<AdapterSentMessage.MyViewHolder> implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.ln_favourite)
        LinearLayout ln_favourite;

        @BindView(R.id.iv_favourite)
        ImageView iv_favourite;

        @BindView(R.id.iv_favourite_red)
        ImageView iv_favourite_red;
    ...
    public AdapterSentMessage(List<BeanMessage> messageList, Activity activity) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.title.setText(movie.toPeopleNames);
        holder.message.setText(movie.subject);
        holder.time.setText(movie.time);
        String t1 = movie.toPeopleNames;
        holder.fname.setText(String.valueOf(t1.charAt(0)).toUpperCase());
        IsFavourite = movie.isFavourite;
        if(IsFavourite.equalsIgnoreCase("A")) {
            holder.iv_favourite_red.setVisibility(View.VISIBLE);
            holder.iv_favourite.setVisibility(View.GONE);
        } else {
            holder.iv_favourite_red.setVisibility(View.GONE);
            holder.iv_favourite.setVisibility(View.VISIBLE);
        }
     //   holder.fname.setText("K");
        ...
        holder.ln_messagelistmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("IsFavourite",messageList.get(position).isFavourite);
                intent.putExtra("frag","Sent");
        ...
        holder.ln_favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.iv_favourite.getVisibility() == View.VISIBLE) {
                    holder.iv_favourite.setVisibility(View.GONE);
                    holder.iv_favourite_red.setVisibility(View.VISIBLE);
                } else {
                    holder.iv_favourite.setVisibility(View.VISIBLE);
