...
public class Adapter1FileShareed3 extends RecyclerView.Adapter<Adapter1FileShareed3.ViewHolder> implements Filterable {
    ...
    public Adapter1FileShareed3(Context context1, List<BeanPeopleFileShare> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        AdapterSharedDrive.recyclerview_adapter3 = new Adapter2FileShareed2(context, AdapterSharedDrive.item_list3);
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    AdapterSharedDrive.item_list3.add(temp);
                    AdapterSharedDrive.recyclerview_adapter3 = new Adapter2FileShareed2(context, AdapterSharedDrive.item_list3);
                    AdapterSharedDrive.rv_onchangelistner3();
                    ...
                    for (int j = 0; j < AdapterSharedDrive.item_list3.size(); j++) {
