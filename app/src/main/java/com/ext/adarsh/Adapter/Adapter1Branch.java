...
public class Adapter1Branch extends RecyclerView.Adapter<Adapter1Branch.ViewHolder> implements Filterable {
    ...
    public Adapter1Branch(Context context1, List<BeanBranchList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        polls.recyclerview_adapter2 = new Adapter2Branch(context, polls.item_list2);
        polls.rv_onchangelistner2();
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    for (int j = 0; j < polls.item_list2.size(); j++) {
                        if (itemlist.branchId.equalsIgnoreCase(Adapter2Branch.list.get(j).getId())) {
                            Adapter2Branch.list.remove(j);
                        }
                    }
