...
public class Adapter2MyEventsPeopleList extends RecyclerView.Adapter<Adapter2MyEventsPeopleList.ViewHolder> {


    Context context;
    static List<ModelClass3> list = new ArrayList<>();

    public Adapter2MyEventsPeopleList(Context context, List<ModelClass3> list) {
        super();
