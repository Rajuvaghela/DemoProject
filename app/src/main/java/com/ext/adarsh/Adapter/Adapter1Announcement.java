...
public class Adapter1Announcement extends RecyclerView.Adapter<Adapter1Announcement.ViewHolder> implements Filterable {
    ...
    public Adapter1Announcement(Context context1, List<BeanDepartmentList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Myannouncement.recyclerview_adapter = new Adapter2Announcement(context, Myannouncement.item_list);
        Myannouncement.rv_onchangelistner();
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    Myannouncement.item_list.add(temp);
                    Myannouncement.recyclerview_adapter = new Adapter2Announcement(context, Myannouncement.item_list);
                    Myannouncement.rv_onchangelistner();
                    ...
                    for (int j = 0; j < Myannouncement.item_list.size(); j++) {
