...
public class AdapterKnowledgeRecent extends RecyclerView.Adapter<AdapterKnowledgeRecent.MyViewHolder> {
    ...
    public AdapterKnowledgeRecent(List<BeanKnowledge> knowledgeList, Activity activity, String parent_class) {
