...
public class Adapter2BranchMyPolls extends RecyclerView.Adapter<Adapter2BranchMyPolls.ViewHolder> {


    Context context;
    static List<ModelClass2> list = new ArrayList<>();

    public Adapter2BranchMyPolls(Context context, List<ModelClass2> list) {
        super();
