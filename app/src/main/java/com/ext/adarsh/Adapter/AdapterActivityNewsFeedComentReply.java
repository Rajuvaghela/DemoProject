...
public class AdapterActivityNewsFeedComentReply extends RecyclerView.Adapter<AdapterActivityNewsFeedComentReply.ViewHolder> {


    Activity activity;
    static List<BeanFeedNewsSubSubComment> list = new ArrayList<>();
    ProgressDialog pd;

    public AdapterActivityNewsFeedComentReply(ArrayList<BeanFeedNewsSubSubComment> list, Activity context) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final BeanFeedNewsSubSubComment temp = list.get(position);

        Glide.with(activity).load(temp.postProfileImage).into(holder.iv_coment_person);
        ...
        holder.tv_coment_person.setText(temp.fullName);
        holder.tv_comment.setText(temp.comment);
        holder.tv_no_of_like.setText(temp.likeCount);

        if (temp.commentPeopleId.equalsIgnoreCase(Utility.getPeopleIdPreference())) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_coment_person, tv_comment;
        ...
        public ViewHolder(View itemView) {
            ...
            iv_coment_person = (ImageView) itemView.findViewById(R.id.iv_coment_person);
