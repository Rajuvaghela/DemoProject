...
public class AdapterSubFile extends RecyclerView.Adapter<AdapterSubFile.MyViewHolder> {
    ...
    public AdapterSubFile(List<BeanSubFiles> messqageList, Activity activity) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ln_messagelistmain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SubFolderActivity.getSubFileData(movie.fileId, movie.parentId);
            }
        });
                            ...
                            if (array.length() != 0) {
                                for (int i = 0; i < array.length(); i++) {
                                    if (array.optJSONObject(i).getString("Status").equalsIgnoreCase("Success")) {
                                        ...
                                        pd.dismiss();
                                        fileshare.dismiss();
                                        SubFolderActivity.getSubFileData(SubFolderActivity.parent_filesList.get(0).fileId, "0");
