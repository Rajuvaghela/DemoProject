...
public class Adapter1TakeActionPeopleList extends RecyclerView.Adapter<Adapter1TakeActionPeopleList.ViewHolder> implements Filterable {
    ...
    public Adapter1TakeActionPeopleList(Context context, List<BeanPeopleSelectByDepartmentId> list) {
        this.list = list;
        this.array = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        TakeActionActivity.recyclerview_adapter3 = new Adapter2TakeActionPeopleList(context, TakeActionActivity.item_list3);
        TakeActionActivity.rv_onchangelistner3();
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    TakeActionActivity.item_list3.add(temp);
                    TakeActionActivity.recyclerview_adapter = new Adapter2TakeActionPeopleList(context, TakeActionActivity.item_list3);
                    TakeActionActivity.rv_onchangelistner3();
                    ...
                    for (int j = 0; j < TakeActionActivity.item_list3.size(); j++) {
                        if (itemlist.peopleId.equalsIgnoreCase(Adapter2TakeActionPeopleList.list.get(j).getId())) {
                            Adapter2TakeActionPeopleList.list.remove(j);
                        }
                    }
