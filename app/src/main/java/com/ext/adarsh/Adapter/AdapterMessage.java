...
public class AdapterMessage extends RecyclerView.Adapter<AdapterMessage.MyViewHolder> implements Filterable {
    ...
    public AdapterMessage(List<BeanMessage> messageList, Activity activity) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ln_favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BeanMessage movie = messageList.get(position);
                messageId = movie.messageId;
                Addtostarred(messageId,position);
    ...
    private void Addtostarred(final String messageId, final int position) {
        is_favourite = false;
        if (checkConnectivity()) {
            //    pd.show();
