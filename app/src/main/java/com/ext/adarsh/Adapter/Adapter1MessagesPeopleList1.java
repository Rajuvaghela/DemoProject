...
public class Adapter1MessagesPeopleList1 extends RecyclerView.Adapter<Adapter1MessagesPeopleList1.ViewHolder> implements Filterable {
    ...
    public Adapter1MessagesPeopleList1(Context context1, List<BeanMessagePeopleList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        MessageCompose.recyclerview_adapter = new Adapter2MessagesPeople1(context, MessageCompose.item_list);
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    MessageCompose.item_list.add(temp);
                    MessageCompose.recyclerview_adapter = new Adapter2MessagesPeople1(context, MessageCompose.item_list);
                    MessageCompose.rv_onchangelistner();
                    ...
                    for (int j = 0; j < MessageCompose.item_list.size(); j++) {
                        if (itemlist.peopleId.equalsIgnoreCase(Adapter2MessagesPeople1.list.get(j).getId())) {
                            Adapter2MessagesPeople1.list.remove(j);
                        }
                    }
                    MessageCompose.rv_onchangelistner();
