...
public class AdapterKnowledgeSubTopicComent extends RecyclerView.Adapter<AdapterKnowledgeSubTopicComent.MyViewHolder> {
    ...
    public AdapterKnowledgeSubTopicComent(List<BeanKnowledgeComment> knowledgeList, Activity activity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tv_comment_like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // KnowledgeArticleList.commentReply();
        ...
        holder.tv_comment_reply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                KnowSubActivity.commentReply(position);
            }
        });
