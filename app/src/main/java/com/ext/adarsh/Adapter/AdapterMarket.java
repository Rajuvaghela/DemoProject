...
public class AdapterMarket extends RecyclerView.Adapter<AdapterMarket.MyViewHolder> implements Filterable {
    ...
    public AdapterMarket(Activity activity, ArrayList<BeanMarket> beanMarkets) {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_edit:
                        ...
                        intent.putExtra("advertisementId", beanMarkets.get(position).advertisementId);
                        intent.putExtra("add_or_edit", "edit");
                        activity.startActivity(intent);

                       // MarketMyAddFragment.create_my_adds("edit");
