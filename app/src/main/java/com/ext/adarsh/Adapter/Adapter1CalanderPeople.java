...
public class Adapter1CalanderPeople extends RecyclerView.Adapter<Adapter1CalanderPeople.ViewHolder> implements Filterable {
    ...
    public Adapter1CalanderPeople(Context context1, List<BeanCalanderPeople> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        AddCalanderEventActivity.recyclerview_adapter3 = new Adapter2CalanderPeople(context, AddCalanderEventActivity.item_list3);
        AddCalanderEventActivity.rv_onchangelistner3();
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    AddCalanderEventActivity.item_list3.add(temp);
                    AddCalanderEventActivity.recyclerview_adapter3 = new Adapter2CalanderPeople(context, AddCalanderEventActivity.item_list3);
                    AddCalanderEventActivity.rv_onchangelistner3();
                    ...
                    for (int j = 0; j < AddCalanderEventActivity.item_list3.size(); j++) {
