...
public class AdapterFeedNews extends RecyclerView.Adapter<AdapterFeedNews.ViewHolder> {
    ...
    List<ModelFeedPostShared> modelFeedPostShareds = new ArrayList<>();
    ...
    public AdapterFeedNews(Activity context, List<BeanFeedNews> bean_feed_news_list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.rv_post_shared_heding.setLayoutManager(flowLayoutManager2);
        ...
        /*
        holder.iv_41.setOnClickListener(this);
        holder.iv_42.setOnClickListener(this);
        holder.iv_43.setOnClickListener(this);
        holder.iv44.setOnClickListener(this);
        holder.iv_51.setOnClickListener(this);
        holder.iv_52.setOnClickListener(this);
        holder.iv_53.setOnClickListener(this);
        holder.iv_54.setOnClickListener(this);
        holder.iv_55.setOnClickListener(this);
        holder.iv_61.setOnClickListener(this);
        holder.iv_62.setOnClickListener(this);
        holder.iv_63.setOnClickListener(this);
        holder.iv_64.setOnClickListener(this);
        holder.iv_65.setOnClickListener(this);*/
        ...
        if (pos.tagFlag.equalsIgnoreCase("Y")) {
            ...
            holder.rv_post_shared_heding.setVisibility(View.GONE);
            holder.tv_post_people_name.setVisibility(View.GONE);
        } else if (pos.shareFlag.equalsIgnoreCase("Y")) {
            holder.tv_post_people_name.setVisibility(View.GONE);
            holder.rv_post_heding.setVisibility(View.GONE);
            holder.rv_post_shared_heding.setVisibility(View.VISIBLE);
        } else {
        ...
        modelFeedPostShareds.clear();
        ModelFeedPostShared test1 = new ModelFeedPostShared();
        test1.setPeopleId(pos.postPeopleId);
        test1.setPeopleName(pos.postPeopleName);
        test1.setIndex("0");
        modelFeedPostShareds.add(test1);

        ModelFeedPostShared test2 = new ModelFeedPostShared();
        test2.setPeopleId("");
        test2.setPeopleName("Shared ");
        test2.setIndex("1");
        modelFeedPostShareds.add(test2);

        ModelFeedPostShared test3 = new ModelFeedPostShared();
        test3.setPeopleId(pos.shareWithIds);
        test3.setPeopleName(pos.shareWithNames);
        test3.setIndex("2");
        modelFeedPostShareds.add(test3);

        ModelFeedPostShared test4 = new ModelFeedPostShared();
        test4.setPeopleId("");
        test4.setPeopleName("'s POST");
        test4.setIndex("3");
        modelFeedPostShareds.add(test4);
        ...
        AdapterFeedPostSharedHeding adapterFeedPostSharedHeding = new AdapterFeedPostSharedHeding(activity, modelFeedPostShareds);
        holder.rv_post_shared_heding.setAdapter(adapterFeedPostSharedHeding);
        ...
        /*if (pos.shareFlag.equalsIgnoreCase("Y")) {
            holder.include_tv_post_people_name.setTypeface(Utility.getTypeFace());
            holder.include_tv_post_date_time.setTypeface(Utility.getTypeFace());
            holder.include_tv_post_title.setTypeface(Utility.getTypeFace());
            holder.include_tv_post_des.setTypeface(Utility.getTypeFace());

            Glide.with(activity).load(bean_feed_news_list.get(position).share_Post_Array.get(0).profileImage).into(holder.iv_post_profile_img);
            if (bean_feed_news_list.get(position).share_Post_Array.get(0).tagFlag.equalsIgnoreCase("Y")) {
                ModelTagFriendName temp51 = new ModelTagFriendName();
                temp51.setPeople_name(" is with ");
                temp51.setPeople_id("");
                temp51.setFlag("N");
                temp51.setPeople_index("0");
                modelTagFriendNames.add(temp51);

                ModelTagFriendName temp21 = new ModelTagFriendName();
                temp21.setPeople_name(bean_feed_news_list.get(position).share_Post_Array.get(0).share_Post_Tag_Friend_One_Array.get(0).personsName);
                temp21.setPeople_id(bean_feed_news_list.get(position).share_Post_Array.get(0).share_Post_Tag_Friend_One_Array.get(0).personsId);
                temp21.setFlag("Y");
                temp21.setPeople_index("2");
                modelTagFriendNames.add(temp21);

            } else {

            }
            if (bean_feed_news_list.get(position).share_Post_Array.get(0).totalPersons.equalsIgnoreCase("2")) {
                ModelTagFriendName temp41 = new ModelTagFriendName();
                temp41.setPeople_name(" and ");
                temp41.setPeople_id("");
                temp41.setFlag("N");
                temp41.setPeople_index("0");
                modelTagFriendNames.add(temp41);

                ModelTagFriendName temp31 = new ModelTagFriendName();
                temp31.setPeople_name(bean_feed_news_list.get(position).share_Post_Array.get(0).share_Post_Tag_Friend_More_Array.get(0).personsName);
                temp31.setPeople_id(bean_feed_news_list.get(position).share_Post_Array.get(0).share_Post_Tag_Friend_More_Array.get(0).personsId);
                temp31.setFlag("Y");
                temp31.setPeople_index("3");
                modelTagFriendNames.add(temp31);
            } else if (bean_feed_news_list.get(position).share_Post_Array.get(0).share_Post_Tag_Friend_More_Array.isEmpty()) {
                ModelTagFriendName temp21 = new ModelTagFriendName();
                temp21.setPeople_name("");
                temp21.setPeople_id("0");
                temp21.setFlag("Y");
                temp21.setPeople_index("0");
                modelTagFriendNames.add(temp21);
            } else {
                ModelTagFriendName temp41 = new ModelTagFriendName();
                temp41.setPeople_name(" and ");
                ...
                ModelTagFriendName temp21 = new ModelTagFriendName();
                temp21.setPeople_name(" " + bean_feed_news_list.get(position).share_Post_Array.get(0).totalPersons + " Others");
                temp21.setPeople_id("0");
                temp21.setFlag("Y");
                temp21.setPeople_index("3");
                modelTagFriendNames.add(temp21);
            }

*//*            AdapterFeedPostSharedHeding adapterFeedPostSharedHeding = new AdapterFeedPostSharedHeding(activity, modelFeedPostShareds);
            holder.include_rv_post_shared_heding.setAdapter(adapterFeedPostSharedHeding);*//*

            AdapterTagPersonName adapterPollsOption1 = new AdapterTagPersonName(activity, modelTagFriendNames, pos.tag_Friend_More_Array);
            holder.include_rv_post_heding.setAdapter(adapterPollsOption1);
            holder.include_tv_post_date_time.setText(bean_feed_news_list.get(position).share_Post_Array.get(0).postDateTime);

            if (bean_feed_news_list.get(position).share_Post_Array.get(0).description.equalsIgnoreCase("")) {
                holder.include_ln_desc.setVisibility(View.GONE);
            } else {
                holder.include_tv_post_title.setText(bean_feed_news_list.get(position).share_Post_Array.get(0).description);
            }

            if (bean_feed_news_list.get(position).share_Post_Array.get(0).isFile.equalsIgnoreCase("D")) {
                holder.include_tv_post_des.setText(bean_feed_news_list.get(position).share_Post_Array.get(0).post);
                //  holder.iv_user_post_image.setVisibility(View.GONE);
                holder.include_tv_post_des.setVisibility(View.VISIBLE);
            } else {
                if (bean_feed_news_list.get(position).share_Post_Array.get(0).fileType.equals("I")) {
                    //  holder.iv_user_post_image.setVisibility(View.VISIBLE);
                    holder.include_videoplayer.setVisibility(View.GONE);
                    //   Glide.with(activity).load(pos.post).into(holder.iv_user_post_image);
                } else {
                    //      holder.iv_user_post_image.setVisibility(View.GONE);
                    holder.include_videoplayer.setVisibility(View.VISIBLE);
                    setVideo(bean_feed_news_list.get(position).share_Post_Array.get(0).post, holder);
                }
                holder.include_tv_post_des.setVisibility(View.GONE);
            }
...
/*        AdapterFeedNews10Image adapterLikePeopleList = new AdapterFeedNews10Image(activity, bean_feed_news_list.get(position).post_Like_People_Array);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        RecyclerView rv_post_heding, rv_post_shared_heding;
        ...
        RelativeLayout include_ll_user_profile;
        CircleImageView include_iv_small_profile_img;
        RecyclerView include_rv_post_heding;
        TextView include_tv_post_people_name, include_tv_post_date_time, include_tv_post_title, include_tv_post_des;
        ImageView include_iv_delete_post, include_iv_user_post_image;
        LinearLayout include_ln_desc, include_ll_post_image_or_des;
        VMVideoView include_videoplayer;

        public ViewHolder(View itemView) {
            super(itemView);

            include_ll_user_profile = (RelativeLayout) itemView.findViewById(R.id.include_ll_user_profile);
            include_iv_small_profile_img = (CircleImageView) itemView.findViewById(R.id.include_iv_small_profile_img);
            include_rv_post_heding = (RecyclerView) itemView.findViewById(R.id.include_rv_post_heding);
            include_tv_post_people_name = (TextView) itemView.findViewById(R.id.include_tv_post_people_name);
            include_tv_post_date_time = (TextView) itemView.findViewById(R.id.include_tv_post_date_time);
            include_tv_post_title = (TextView) itemView.findViewById(R.id.include_tv_post_title);
            include_tv_post_des = (TextView) itemView.findViewById(R.id.include_tv_post_des);
            include_iv_delete_post = (ImageView) itemView.findViewById(R.id.include_iv_delete_post);
            include_iv_user_post_image = (ImageView) itemView.findViewById(R.id.include_iv_user_post_image);
            include_ln_desc = (LinearLayout) itemView.findViewById(R.id.include_ln_desc);
            include_ll_post_image_or_des = (LinearLayout) itemView.findViewById(R.id.include_ll_post_image_or_des);
            include_videoplayer = (VMVideoView) itemView.findViewById(R.id.include_videoplayer);


            rv_post_shared_heding = (RecyclerView) itemView.findViewById(R.id.rv_post_shared_heding);
