...
public class AdapterSubFileShared extends RecyclerView.Adapter<AdapterSubFileShared.MyViewHolder> {
    ...
    static Adapter1FileShareed4 adapter1people;
    ...
    public AdapterSubFileShared(List<BeanSubFiles> messqageList, Activity activity) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ln_messagelistmain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SubFolderActivityShared.getSubFileData(movie.fileId, movie.parentId);
            }
        });
    ...
    private void filesharingDialog(int pos, final String fileid, final String oldFileName,
        ...
        fileshare.setContentView(R.layout.sub_file_shareing_with_me);
        ...
        ll_move_dialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SubFolderActivityShared.rl_move_or_copy.setVisibility(View.VISIBLE);
                SubFolderActivityShared.upload_float.setVisibility(View.GONE);
                ...
                SubFolderActivityShared.file_move_or_not = "yes";
                fileshare.dismiss();
            }
        });
        fileshare.show();
...
// tv_select_person ,tv_visible_person
    ...
    private static void openTagPopuppeople() {
        ...
        adapter1people = new Adapter1FileShareed4(activity2, contact_list);
                            ...
                            if (array.length() != 0) {
                                for (int i = 0; i < array.length(); i++) {
                                    if (array.optJSONObject(i).getString("Status").equalsIgnoreCase("Success")) {
                                        ...
                                        pd.dismiss();
                                        fileshare.dismiss();
                                        SubFolderActivityShared.getSubFileData(SubFolderActivityShared.parent_filesList.get(0).fileId, "0");
