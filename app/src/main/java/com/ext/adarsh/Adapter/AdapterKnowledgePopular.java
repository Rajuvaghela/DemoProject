...
public class AdapterKnowledgePopular extends RecyclerView.Adapter<AdapterKnowledgePopular.MyViewHolder> {
    ...
    public AdapterKnowledgePopular(List<BeanKnowledge> knowledgeList, Activity activity, String parent_class) {
