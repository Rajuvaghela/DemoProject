...
import com.ext.adarsh.Bean.BeanFeedNewsLikePeopleArray;
...
public class AdapterLikePeopleList extends RecyclerView.Adapter<AdapterLikePeopleList.ViewHolder> {

    Activity activity;
    List<BeanFeedNewsLikePeopleArray> list = new ArrayList<>();
    ProgressDialog pd;
    public AdapterLikePeopleList(Activity activity, List<BeanFeedNewsLikePeopleArray> list) {
        super();
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv_group_name.setText(list.get(position).likePeopleName);
