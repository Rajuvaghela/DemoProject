...
import com.ext.adarsh.Activity.EditAnnouncementActivity;
...
public class Adapter1AnnouncementEdit extends RecyclerView.Adapter<Adapter1AnnouncementEdit.ViewHolder> implements Filterable {
    ...
    public Adapter1AnnouncementEdit(Context context1, List<BeanDepartmentList> list) {
        this.list = list;
        this.array = list;
        context = context1;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        EditAnnouncementActivity.recyclerview_adapter = new Adapter2Announcement(context, EditAnnouncementActivity.item_list);
        EditAnnouncementActivity.rv_onchangelistner();
        ...
        holder.chkSelected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (list.get(position).isSelected() == false) {
                    ...
                    EditAnnouncementActivity.item_list.add(temp);
                    EditAnnouncementActivity.recyclerview_adapter = new Adapter2Announcement(context, EditAnnouncementActivity.item_list);
                    EditAnnouncementActivity.rv_onchangelistner();
                    ...
                    for (int j = 0; j < EditAnnouncementActivity.item_list.size(); j++) {
                        if (itemlist.departmentId.equalsIgnoreCase(Adapter2Announcement.list.get(j).getId())) {
                            Adapter2Announcement.list.remove(j);
                        }
                    }
                    EditAnnouncementActivity.rv_onchangelistner();
