...
public class AdapterColleguesList extends BaseAdapter {

    Activity act;
    List<BeanColleaguesList> arrayList;

    public AdapterColleguesList(Activity act, List<BeanColleaguesList> arrayList) {
        this.act = act;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (arrayList.get(i).fullName.equalsIgnoreCase("Select Colleagues")) {
