...
import com.ext.adarsh.Bean.BeanKnowledgeSubComment;
...
public class AdapterKnowSubTopicSubComent extends RecyclerView.Adapter<AdapterKnowSubTopicSubComent.MyViewHolder> {

    private List<BeanKnowledgeSubComment> knowledgeList;
    Activity activity;
    Dialog dd;
    ...
    public AdapterKnowSubTopicSubComent(List<BeanKnowledgeSubComment> knowledgeList, Activity activity) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final BeanKnowledgeSubComment knowledge = knowledgeList.get(position);
        ...
        holder.tv_comment_like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                holder.tv_comment_like_red.setVisibility(View.VISIBLE);
                holder.tv_comment_like.setVisibility(View.GONE);
                KnowSubActivity.knowledge_coment_like();
