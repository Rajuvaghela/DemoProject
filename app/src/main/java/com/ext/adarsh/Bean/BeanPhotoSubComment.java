...
public class BeanPhotoSubComment implements Parcelable {
    ...
    @SerializedName("CommentReplayLikeDislikeFlag")
    public String commentReplayLikeDislikeFlag;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.commentReplayLikeDislikeFlag);
        dest.writeString(this.commentPeopleFullName);
    }

    public BeanPhotoSubComment() {
    }

    protected BeanPhotoSubComment(Parcel in) {
        ...
        this.commentReplayLikeDislikeFlag = in.readString();
    }

    public BeanPhotoSubComment(String fullName, String profileImage, String postProfileImage, String postCommentId, String albumId, String albumDetailId, String postId, String postPeopleId, String commentPeopleId, String parentId, String comment, String likesUserId, String likeCount, String likeStatus) {
        ...
        this.commentReplayLikeDislikeFlag = likeStatus;
    }

    public static final Creator<BeanPhotoSubComment> CREATOR = new Creator<BeanPhotoSubComment>() {
        @Override
        public BeanPhotoSubComment createFromParcel(Parcel source) {
            return new BeanPhotoSubComment(source);
        }

        @Override
        public BeanPhotoSubComment[] newArray(int size) {
            return new BeanPhotoSubComment[size];
        }
    };
}
