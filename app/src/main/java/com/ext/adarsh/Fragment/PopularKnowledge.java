...
import com.ext.adarsh.Adapter.AdapterKnowledgePopular;
 ...
 */
public class PopularKnowledge extends Fragment {
    static ProgressDialog pd;
    private static List<BeanKnowledge> knowledge_popular_List = new ArrayList<>();
    public static AdapterKnowledgePopular mAdapter;
    ...
    public static void getAllDataKnowledge() {
        ...
        if (checkConnectivity()) {
            StringRequest request = new StringRequest(Request.Method.POST, AppConstant.Knowledge_Topic_Filter_By_Popular, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Log.e("know_pop", response);
                    try {
                        ...
                        if (object.has("Knowledge_Topic_Array")) {
                            ...
                            if (jsonArray.length() != 0) {
                                knowledge_popular_List.clear();
                                knowledge_popular_List.addAll((Collection<? extends BeanKnowledge>) new Gson().fromJson(jsonArray.toString(), new TypeToken<ArrayList<BeanKnowledge>>() {
                                }.getType()));
                                mAdapter = new AdapterKnowledgePopular(knowledge_popular_List, activity, "popular");
