...
public class StarredFragment extends Fragment {
    ...
    private static AdapterMessage mAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.starred, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        message();
        mAdapter.setOnLoadMoreListener(new AdapterMessage.OnLoadMoreListener() {
            @Override
    ...
    public static void message() {
        if (checkConnectivity()) {
            pd.show();
            StringRequest request = new StringRequest(Request.Method.POST, AppConstant.Message_Starred_Select_All, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Log.e("res", response);
                    try {
                        JSONObject object = new JSONObject(response);
                        if (object.has("Message_Starred_Select_All_Array")) {
                            JSONArray jsonArray = object.getJSONArray("Message_Starred_Select_All_Array");
                        ...
                        if (object.has("Message_Starred_Pagination_Array")) {
                            JSONArray jsonArray = object.getJSONArray("Message_Starred_Pagination_Array");
                            if (jsonArray.length() != 0) {
                        ...
                        if (object.has("Message_Starred_Total_Array")) {
                            JSONArray jsonArray = object.getJSONArray("Message_Starred_Total_Array");
                            if (jsonArray.length() != 0) {
