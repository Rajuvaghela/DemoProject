 ...
 */
public class activty_message extends Fragment {
    ...
    public static AdapterMessage mAdapter;
   ...
   /* @BindView(R.id.commingsoon)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.notification_message, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
     ...
     //   commingsoon.setTypeface(Utility.getTypeFaceTab());
        ...
        composemail_float.setVisibility(view.INVISIBLE);
    ...
    public static void message() {
        if (checkConnectivity()) {
            //    pd.show();
            StringRequest request = new StringRequest(Request.Method.POST, AppConstant.Message_Inbox_Select_All, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Log.e("res", response);
                    try {
                        JSONObject object = new JSONObject(response);
                        if (object.has("Message_Inbox_Select_All_Array")) {
                            JSONArray jsonArray = object.getJSONArray("Message_Inbox_Select_All_Array");
                        ...
                        if (object.has("Message_Inbox_Pagination_Array")) {
                            JSONArray jsonArray = object.getJSONArray("Message_Inbox_Pagination_Array");
                            if (jsonArray.length() != 0) {
                        ...
                        if (object.has("Message_Inbox_Total_Array")) {
                            JSONArray jsonArray = object.getJSONArray("Message_Inbox_Total_Array");
                            if (jsonArray.length() != 0) {
